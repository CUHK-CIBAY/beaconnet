...
const SettingPrivacy = () => (
  <div className="setting-privacy-safety-container">
    <div className="setting-privacy-safety-header">
      Privacy and Safety
    </div>
    <div className="privacy-safety-your-bits">
      <div>
        <p className="privacy-safety-your-bits-header">
          Your Bits
        </p>
        <div className="privacy-safety-your-bits-content">
          Manage the information associated with your Bits
        </div>
      </div>
    ...
    <div className="privacy-safety-content-see">
      <div>
        <p className="privacy-safety-content-see-header">
          Content you see
        </p>
