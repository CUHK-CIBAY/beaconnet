...
const SettingAccessibility = () => (
  <div className="setting-accessibility-container">
    <div className="setting-accessibility-header">Accessibility</div>
    <div className="accessibility-font-size">
      <div>
        <p className="accessibility-font-size-header">Font Size</p>
        <div className="accessibility-font-size-content">Choose the font size for your perferencees</div>
      </div>
